...
You should see the following if you visit [http://localhost:8000](http://localhost:8000):
...
And point our browser at [http://localhost:8000/](http://localhost:8000/) and see the list of available url endpoints:
...
You should be able to visit [http://localhost:8000/snippets/](http://localhost:8000/snippets/) and use the form rendered by the REST framework's Browseable API to create a few snippets, then visit [http://localhost:8000/snippets/](http://localhost:8000/snippets/) to view them.
